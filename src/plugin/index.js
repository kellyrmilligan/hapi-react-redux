...
async function hapiReactReduxPlugin (server, options) {
  ...
  server.decorate('toolkit', 'hapiReactReduxRender', async function hapiReactReduxRender (context) {
    ...
    try {
      ...
      try {
        ...
        throw Boom.badImplementation(`There was an error rendering the route - ${this.request.raw.req.url}`, err)
      }
      ...
      try {
        ...
        throw Boom.badImplementation(`There was an error rendering the layout while rendring the route - ${this.request.raw.req.url}`, err)
      }
  ...
  server.decorate('handler', 'hapiReactReduxHandler', function (route, options) {
